/**
 * @file statistics.hpp
 * @brief A header-only library providing basic statistical functions.
 *
 * This module implements templated utility functions for statistical analysis
 * on vectors of numeric data. It includes functionality to compute:
 * - Mean
 * - Variance (population and sample)
 * - Covariance (population and sample)
 *
 * All functions are generic and work with any arithmetic data type (e.g., int, float, double).
 * They perform input validation and throw exceptions on invalid input (e.g., empty vectors or size mismatches).
 *
 * @author Harsh Parikh
 * @date 31st May 2025
 */
