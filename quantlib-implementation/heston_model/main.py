...
class QuantlibCalibration:
    ...
    def fit_model(self):
        ...
        day_count = ql.Actual365Fixed() # This line ensures that the number of days are set to 365
        calendar = ql.UnitedStates(ql.UnitedStates.GovernmentBond) # Calendar set according to the American standard

        today = datetime.today()
        calculation_date = ql.Date(today.day, today.month, today.year) 
        self.calculation_date = calculation_date

        ql.Settings.instance().evaluationDate = calculation_date # This line is used to set a pivot for today's date.
